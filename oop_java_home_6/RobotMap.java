...
public class RobotMap {
    ...
    public RobotInterface createRobot(Point point) {
        validatePoint(point);
        RobotInterface robot = new Robot(point);      // создание объекта класса Robot
    ...
    public Optional<RobotInterface> getById(Long id) {    //  в методе тип Robot заменен на интерфейс RobotInterface
        for (Robot robot : robots) {
    ...
    public class Robot implements RobotInterface {
        ...
        public void delete(Long robotId) {                       
            ...
            while(robotIterator.hasNext()) {
                ...
                if (robotId.equals(nextRobot.id)) {
