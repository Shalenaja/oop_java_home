...
public class HomeWorkMain {
    ...
    public static void main(String[] args) {
        ...
        orangeBox.add(new Orange(2.5));
        //orangeBox.add(new Apple(1.0)); // Не должно работать!
        //orangeBox.add(new GoldenApple(2.0)); // Не должно работать!
        System.out.println(orangeBox.getWeight()); // 5.5
        //orangeBox.moveTo(goldenAppleBox); // Не должно работать!
        Box<Orange> orangeBox_2 = new Box<>();
        orangeBox_2.add(new Orange(1));
        orangeBox.moveTo(orangeBox_2);
        System.out.println(orangeBox_2.getWeight()); // 6.5
